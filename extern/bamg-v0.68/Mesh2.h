...
inline void MyAssert1(int i,char * ex,char * file,long line)
{if (i) MyAssert(i,ex,file,line);}
#define assert(i) MyAssert1((i)==0,#i,__FILE__,__LINE__)
//#endif 
#endif
...
// end of variable
  ...
  Triangles(Int4 i) :BTh(*this),Gh(*NULLGeometry){PreInit(i);}
